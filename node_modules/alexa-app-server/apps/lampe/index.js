...
app.launch(function(req, res) {
	res.say('Wie kann ich dir behilflich sein?');
} );
  ...
  function(req,res) {
    ...
    switch(farbe){
			...
			case "hilfe":
				...
				break;
			default:
				res.say("Entschuldigung, diese Farbe kenne ich nicht. Sage Hilfe um alle Farben zu erfahren.");
		}
		var link = "";
		if(red == 0){
			link = link + "000";
		...
		request.get("http://79.247.243.38/"+link, function (error, response, body) {
